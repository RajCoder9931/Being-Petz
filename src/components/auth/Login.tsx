...
//           <p className="text-gray-600 mb-4">Please Enter your information below and started your pet care.</p>
...
//                   className="mr-2"
//                 />
//                 <label htmlFor="rememberMe" className="text-gray-700">Accept Terms and Conditions <span className='text-purple-600 hover:underline'>Read Now</span></label>
//               </div>
//             </div>
