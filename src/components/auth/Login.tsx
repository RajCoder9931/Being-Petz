...
//             Enter your email address and password to acces your account
//           </p>
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      // 👉 console me pura user data print karein
      ...
      // user details bhi store karein agar backend bhej raha hai
      if (data.user) {
    ...
    <div className="flex min-h-screen w-full">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          {message && (
            <div className={`mb-4 text-sm font-medium ${message.includes("✅") ? "text-green-600" : "text-red-600"}`}>
              {message}
            </div>
          )}
